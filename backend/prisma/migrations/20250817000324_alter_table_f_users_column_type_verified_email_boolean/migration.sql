/*
  ...
  - You are about to alter the column `verified_email` on the `users` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Boolean`.
